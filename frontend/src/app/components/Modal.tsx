  ...
  return createPortal(
    ...
    >
      ...
      <div className="absolute inset-0 flex items-end md:items-center justify-center p-2 md:p-4 pointer-events-none">
        ...
        <div
          className="
            pointer-events-auto w-full md:max-w-3xl
          bg-white shadow-[0_10px_30px_rgba(0,0,0,0.08)] ring-1 ring-black/5
        ...
        >
          ...
          {/* ボディ：ここがスクロールする */}
          <div className="px-6 py-6 pb-[max(env(safe-area-inset-bottom),1.25rem)]">
            {children}
          </div>
        </div>
      </div>
